...
\lstinline![|- t_if_then_else D D1 D2]!, where
...
\todo{The cases for t_if_then_else are more complicated than I'd like them to be
...
| [|- t_true]  => ?
| [|- t_false] => ?
| [|- t_if_then_else D D1 D2] : [|- hastype (if_then_else M M1 M2) T] =>
  (case terminate [|- D] of
  | [|- result MS v_true] =>
...
\begin{center}
	\lstinline!| [|- t_if_then_else D D1 D2] : [|- hastype (if_then_else M M1 M2) T] =>!
\end{center}
