...
\todo{Need to move the comment about giving a type annotation to a pattern (pg. 43)
	here, because it's necessary for this proof and never explained anywhere. -ah}
